...
from mininet.node import Controller, OVSKernelAP, OVSSwitch, OVSAP
...
def emptynet():
    ...
    print( '*** Adding Nodes\n' )
    sta1 = net.addStation( 'sta1', ip='192.168.0.1', mac = '00:00:00:00:00:01', position='130,140,0' )  #Desktop connected to home network
    ...
    sta1.cmdPrint('route add default gw 192.168.0.254 sta1-wlan0')
    sta1.cmdPrint('arp -s 192.168.0.254 00:00:00:00:00:11:11')    
