...
from mininet.node import  Controller, UserAP, OVSKernelAP, OVSAP, OVSSwitch
...
def topology():
    "Create a network."
    net = Mininet( controller=Controller, link=TCLink, accessPoint=OVSKernelAP, enable_wmediumd=True, enable_interference=False )
