...
def MudNet():
    ...
    info( '*** Adding network hosts\n' )
    h1 = net.addHost( 'h1')  #Desktop connected to home network
    h2 = net.addHost( 'h2')  #IoT Device LED Light connected to home network
    h3 = net.addHost( 'h3') ####### IP address allowed for communication
    ...
    h1.cmd('ifconfig h1-eth0 hw ether 00:00:00:00:00:01 192.168.0.1')
    h2.cmd('ifconfig h1-eth0 hw ether 00:00:00:00:00:02 192.168.0.2')
    h3.cmd('ifconfig h1-eth0 hw ether 00:00:00:00:00:03 '+x[0])
